...
const Contact = () => {
  ...
  return (
    <Layout>
      ...
      <div className="ml-3 block text-base font-medium text-gray-900" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
      <Typography variant="h4">Contact to Mentoons Family</Typography>
        <p>
