...
const About = () => {
  ...
  return (
    <Layout>
      <div className="home" style={{ backgroundImage: `url(${pic14})` }}>
      <Box
        sx={{
          my: 15,
          textAlign: "center",
      ...
      >
        ...
        <div className="ml-3 block text-base font-medium text-gray-900" style={{ backgroundColor: mode === 'dark' ? 'rgb(166, 89, 89)' : '', color: mode === 'dark' ? 'white' : '', }}>
        <Typography variant="h4">Welcome To Mentoons Family</Typography>
        <p>
