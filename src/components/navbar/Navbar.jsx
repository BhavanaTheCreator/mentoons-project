...
import pic11 from '../../mentoons ecommerce products/pic11.jpg'
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <img className="inline-block w-10 h-10 rounded-full" src = {img} alt="Dan_Abromov"  ></img>
                   </Link>  
                   </div>
            ...
            <div className="flex h-16 items-center">
              ...
              {/* Logo */}
               <div className="ml-4 flex lg:ml-0">
                <img src = {pic11} alt="MENTOONS" Width="200" height="10" style={{ color: mode === 'dark' ? 'white' : '', }}></img>
                   </div>  
