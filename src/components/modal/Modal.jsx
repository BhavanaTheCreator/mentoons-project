...
export default function Modal({ name, address, pincode, phoneNumber, setName, setAddress, setPincode, setPhoneNumber, buyNow }) {
    ...
    return (
        <>
            <div className="  text-center rounded-lg text-blue font-bold">
                <button
                    type="button"
                    onClick={openModal}
                   
                     className="w-full  bg-blue-600 py-2 text-center rounded-lg text-grey font-bold " 
...
{/*                                                    */}       
                                                       <div>  
                                                            <h1 className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0" >Cart Item</h1>
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="focus:outline-none w-full text-blue bg-purple-600 hover:bg-purple-800  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Order Now</button>
